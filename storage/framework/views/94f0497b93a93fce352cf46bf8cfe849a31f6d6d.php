                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="<?php echo e(route('category.single', ['id' => $post->category->id ])); ?>"><?php echo e($post->category->name); ?></a>
                                </li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                ...
                                <span class="category"><i class="lni lni-folder"></i> <a
                                        href="<?php echo e(route('category.single', ['id' => $post->category->id ])); ?>"><?php echo e($post->category->name); ?></a> </span>
                        ...
                        <div class="tags-box">
                            <ul>
                                <?php $__currentLoopData = $post->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="<?php echo e(route('tag.single', ['id' => $tag->id ])); ?>"
