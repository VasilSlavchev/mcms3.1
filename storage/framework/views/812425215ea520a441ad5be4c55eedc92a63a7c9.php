        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="banner-content">
                    <h2 class="text-white">Tag: <?php echo e($tag->tag); ?></h2>
                            ...
                            <div class="blog-content">
                                ...
                                <div class="blog-meta">
                                    ...
                                    <span class="category"><i class="lni lni-folder"></i> <a
                                            href="<?php echo e(route('post.single', ['id' => $post->slug ])); ?>"><?php echo e($post->title); ?></a> </span>
...
<?php /**PATH C:\laragon\www\mcms3.1\resources\views/tag.blade.php ENDPATH**/ ?>